...
//             <Link href="/for-travelers" className="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline underline-offset-4">
//               For Travelers
//             </Link>
...
//         <section id="join" className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-green-400 to-blue-500 text-white">
//           <div className="container mx-auto px-4 md:px-6">
